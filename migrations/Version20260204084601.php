 ...
 */
final class Version20260204084601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personnage ADD damage INT NOT NULL, ADD hp INT NOT NULL, DROP dmg_stat, DROP hp_stat');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personnage ADD dmg_stat INT NOT NULL, ADD hp_stat INT NOT NULL, DROP damage, DROP hp');
