 ...
 */
final class Version20260209151217 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE role (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, personnage_id INT DEFAULT NULL, INDEX IDX_57698A6A5E315342 (personnage_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
